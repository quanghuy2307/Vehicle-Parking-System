...
if (!isset($_SESSION['aid'])) {
    ...
    if (isset($_GET['userID']))
    {
        ...
        $col = mysqli_fetch_array(mysqli_query($conn, "SELECT * FROM `user_info_tbl` WHERE `ID` = '$id';"));
                ...
                <div class="sb-sidenav-menu">
                    <div class="nav">
                        ...
                        <div class="collapse" id="collapseUsers" aria-labelledby="headingTwo" data-bs-parent="#sidenavAccordion">
                            <nav class="sb-sidenav-menu-nested nav">
								<a class="nav-link" href="./all-users.php"><div class="sb-nav-link-icon"><i class='bx bx-border-all'></i></div>All</a>
        ...
        <section id="sidenav_content">
            ...
            <header>
                <div class="container-fluid px-4">
                    <h1 class="mt-4">Premium User Detail</h1>

                    <ol class="breadcrumb mb-4">
                        <li class="breadcrumb-item"><a href="./dashboard.php">Dashboard</a></li>
                        <li class="breadcrumb-item"><a href="./premium-users.php">Premium Users</a></li>
                        <li class="breadcrumb-item active">Premium User Detail</li>
                    </ol>
                </div>
            </header>
                            ...
                            <form method="post" class="needs-validation" action="code.php" autocomplete="off" novalidate>
                                <div class="row">
                                    <div class="col-sm-6 mb-3">
                                        ...
                                        <input type="text" id="name" class="form-control" name="name" value="<?php echo $col['FullName']; ?>">
                                        <div class="invalid-feedback">Fullname is required.</div>
                                    </div>

                                    <div class="col-sm-6 mb-3">
                                        <label class="form-label" for="email">Email</label>
                                        <input type="email" id="email" class="form-control" name="email" value="<?php echo $col['Email']; ?>" disabled>
                                    </div>
                                    ...
                                    <div class="col-sm-6 mb-3">
                                        ...
                                        <div class="d-flex justify-content-around">
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="gender" id="female" value="Female" <?php if ($col['Gender'] == "Female") {echo "checked";}; ?>>
                                                <label class="form-check-label" for="female">Female</label>
                                            </div>
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="gender" id="others" value="Others" <?php if ($col['Gender'] == "Others") {echo "checked";}; ?>>
                                    ...
                                    <div class="col-sm-6 mb-3">
                                        ...
                                        <input type="text" id="regdate" class="form-control" name="regdate" value="<?php echo $col['RegisterDate']; ?>" disabled>
                                    </div>

                                    <div class="col-sm-6 mb-3">
                                        <label class="form-label" for="birthday">Birthday</label>
                                        <input type="date" id="birthday" class="form-control" name="birthday" value="<?php echo $col['Birthday']; ?>">
                                        <div class="invalid-feedback">Birthday is required.</div>
                                    </div>

                                    <div class="col-sm-6 mb-3">
                                        <label class="form-label" for="phone">Phone Number</label>
                                        <input type="tel" id="phone" class="form-control" name="phone" value="<?php echo $col['PhoneNumber']; ?>">
                                        <div class="invalid-feedback">Phone number is required.</div>
                                    </div>

                                    <div class="col-sm-6 mb-3">
                                        <label class="form-label" for="address">Address</label>
                                        <input type="text" id="address" class="form-control" name="address" value="<?php echo $col['Address']; ?>">
                                        <div class="invalid-feedback">Address is required.</div>
                                    </div>

                                    <div class="col-sm-6 mb-3">
                                        <label class="form-label" for="cardID">Card ID</label>
                                        <input type="text" id="cardID" class="form-control" name="cardID" value="<?php echo $col['CardID']; ?>">
                                    </div>

                                    <div class="col-sm-6 mb-3">
                                        <label class="form-label" for="type">Type</label>
                                        <select id="type" class="form-select" name="type" aria-label="Type select">
                                            <option <?php if ($col['Type'] == "Nomal") {echo "selected";} ?> value="Nomal">Nomal</option>
                                            <option <?php if ($col['Type'] == "Premium") {echo "selected";} ?> value="Premium">Premium</option>
                                        </select>
                                    </div>

                                    <div class="col-sm-6 mb-3">
                                        <label class="form-label" for="status">Status</label>
                                            <select id="status" class="form-select" name="status" aria-label="Status select">
                                                <option <?php if ($col['Status'] == "Active") {echo "selected";} ?> value="Active">Active</option>
                                                <option <?php if ($col['Status'] == "Inactive") {echo "selected";} ?> value="Inactive">Inactive</option>
                                            </select>
                                    </div>

                                    <div class="row">
                                        <div class="d-flex justify-content-end">
                                            <button type="submit" class="btn btn-primary me-4" name="resetPasswordPremiumUser" value="<?php echo $col['ID']; ?>">Reset Password</button>
                                            <button type="submit" class="btn btn-warning" name="updateInformationPremiumUser" value="<?php echo $col['ID']; ?>">Update Information</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
