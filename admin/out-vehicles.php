        ...
        <section id="sidenav_content">
            ...
            <header>
                <div class="container-fluid px-4">
                    <h1 class="mt-4">Out Vehicles</h1>

                    <ol class="breadcrumb mb-4">
                        <li class="breadcrumb-item"><a href="./dashboard.php">Dashboard</a></li>
                        <li class="breadcrumb-item active">Out Vehicles</li>
                    </ol>
                </div>
            </header>
                                ...
                                <div class="table-responsive">
                                    <table id="myTable" class="table table-sm table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            $res = mysqli_query($conn, "SELECT * FROM `vehicle_info_tbl` WHERE `Status` = 'Out';");
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a class="btn btn-link" href="out-vehicle-view.php?vehicleID=<?php echo $row['ID']; ?>" title="View" data-toggle="tooltip"><i class="fa-solid fa-eye text-primary"></i></a>
                                                    <a class="btn btn-link" href="out-vehicle-print.php?vehicleID=<?php echo $row['ID']; ?>" title="Print" data-toggle="tooltip"><i class="fa-solid fa-print text-secondary"></i></a>
                                                    <form action="code.php" method="POST" class="d-inline">
                                                        <button type="submit" title="Delete" data-toggle="tooltip" name="deleteOutVehicle" value="<?php echo $row['ID']; ?>" class="btn btn-link"><i class="fa-solid fa-trash-can text-danger"></i></button>
                                                    </form>
                                                </td>
                                            </tr>
                                            <?php
