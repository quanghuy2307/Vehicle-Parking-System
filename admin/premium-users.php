        ...
        <section id="sidenav_content">
            ...
            <header>
                <div class="container-fluid px-4">
                    <h1 class="mt-4">Premium Users</h1>
                                ...
                                <div class="table-responsive">
                                    <table id="myTable" class="table table-sm table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            $res = mysqli_query($conn, "SELECT * FROM `user_info_tbl` WHERE `Type` = 'Premium';");
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a class="btn btn-link" href="premium-user-detail.php?userID=<?php echo $row['ID']; ?>" title="Detail" data-toggle="tooltip"><i class="fa-solid fa-pencil text-warning"></i></a>
                                                    <form action="code.php" method="POST" class="d-inline">
                                                        <button type="submit" title="Delete" data-toggle="tooltip" name="deletePremiumUser" value="<?php echo $row['ID']; ?>" class="btn btn-link"><i class="fa-solid fa-trash-can text-danger"></i></button>
                                                    </form>
                                                </td>
                                            </tr>
                                            <?php
