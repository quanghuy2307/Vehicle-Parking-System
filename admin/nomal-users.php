        ...
        <section id="sidenav_content">
            ...
            <header>
                <div class="container-fluid px-4">
                    <h1 class="mt-4">Nomal Users</h1>

                    <ol class="breadcrumb mb-4">
                        <li class="breadcrumb-item"><a href="./dashboard.php">Dashboard</a></li>
                        <li class="breadcrumb-item active">Nomal Users</li>
                    </ol>
                </div>
            </header>
                                ...
                                <div class="table-responsive">
                                    <table id="myTable" class="table table-sm table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            $res = mysqli_query($conn, "SELECT * FROM `user_info_tbl` WHERE `Type` = 'Nomal';");
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <p class="rounded d-inline-block p-1 <?php if ($row['Status'] == "Active") {echo "text-white bg-success";} elseif ($row['Status'] == "Inactive") {echo "text-white bg-secondary";}?>"><small><?php echo $row['Status']; ?></small></p>
                                                </td>
                                                <td>
                                                    <a class="btn btn-link" href="nomal-user-detail.php?userID=<?php echo $row['ID']; ?>" title="Detail" data-toggle="tooltip"><i class="fa-solid fa-pencil text-warning"></i></a>
                                                    <form action="code.php" method="POST" class="d-inline">
                                                        <button type="submit" title="Delete" data-toggle="tooltip" name="deleteNomalUser" value="<?php echo $row['ID']; ?>" class="btn btn-link"><i class="fa-solid fa-trash-can text-danger"></i></button>
                                                    </form>
                                                </td>
                                            </tr>
                                            <?php
