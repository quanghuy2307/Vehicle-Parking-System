        ...
        <section id="sidenav_content">
            ...
            <header>
                <div class="container-fluid px-4">
                    <h1 class="mt-4">Nomal User Detail</h1>

                    <ol class="breadcrumb mb-4">
                        <li class="breadcrumb-item"><a href="./dashboard.php">Dashboard</a></li>
                        <li class="breadcrumb-item"><a href="./nomal-users.php">Nomal Users</a></li>
                        <li class="breadcrumb-item active">Nomal User Detail</li>
                    </ol>
                </div>
            </header>
                                ...
                                <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="d-flex justify-content-end">
                                            <button type="submit" class="btn btn-primary me-4" name="resetPasswordNomalUser" value="<?php echo $col['ID']; ?>">Reset Password</button>
                                            <button type="submit" class="btn btn-warning" name="updateInformationNomalUser" value="<?php echo $col['ID']; ?>">Update Information</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
