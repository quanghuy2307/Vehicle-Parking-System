        ...
        <section id="sidenav_content">
            ...
            <header>
                <div class="container-fluid px-4">
                    <h1 class="mt-4">Out Vehicle View</h1>

                    <ol class="breadcrumb mb-4">
                        <li class="breadcrumb-item"><a href="./dashboard.php">Dashboard</a></li>
                        <li class="breadcrumb-item"><a href="./out-vehicles.php">Out Vehicles</a></li>
                        <li class="breadcrumb-item active">Out Vehicle View</li>
                    </ol>
                </div>
            </header>
                        ...
                        <div class="card-body">
                            <form method="post" class="needs-validation" action="code.php" autocomplete="off" novalidate>
                                <div class="row">
                                    ...
                                    <div class="col-sm-6 mb-3">
                                        <label class="form-label" for="outTime">Out Time</label>
                                        <input type="text" id="outTime" class="form-control" name="outTime" value="<?php echo $col['OutTime']; ?>" disabled>
                                    </div>
                                    ...
                                    <div class="col-sm-12 mb-3">
                                        <label class="form-label" for="charge">Total Charge</label>
