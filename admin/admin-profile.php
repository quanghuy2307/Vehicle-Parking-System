...
if (!isset($_SESSION['aid'])) {
    ...
    $id = $_SESSION['aid'];
    $col = mysqli_fetch_array(mysqli_query($conn, "SELECT * FROM `admin_info_tbl` WHERE `ID` = '$id';"));
                        ...
                        <div class="card-body">
                            <form method="post" class="needs-validation" action="code.php" autocomplete="off" novalidate>
                                ...
                                <div class="d-flex justify-content-center">
                                    <div>
                                        <button type="submit" name="updateAdminInfo" value="<?php echo $id ?>" class="btn btn-outline-primary">Update</button>
                                    </div>
                                </div>
                            </form>
                        </div>
