...
<head>
    ...
    <!-- Title -->
    <title>Automatic Vehicle Parking System - User Dashboard</title>
...
<body>
    ...
    <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
        <!-- Navbar Brand-->
        <a class="navbar-brand ps-3 ps-lg-4" href="./dashboard.php">Dashboard</a>
            ...
            <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                ...
                <div class="sb-sidenav-menu">
                    <div class="nav">
                        ...
                        <a class="nav-link" href="./dashboard.php"><div class="sb-nav-link-icon"><i class='bx bxs-dashboard'></i></div>Dashboard</a>

                        <div class="sb-sidenav-menu-heading">Information</div>
                        <a class="nav-link" href="./notification.php"><div class="sb-nav-link-icon"><i class='bx bxs-bell'></i></div>Notification</a>
                        <a class="nav-link" href="./mesage.php"><div class="sb-nav-link-icon"><i class='bx bxs-envelope'></i></div>Message</a>

                        <div class="sb-sidenav-menu-heading">View</div>
                        <a class="nav-link" href="./vehicle.php"><div class="sb-nav-link-icon"><i class='bx bxs-car'></i></div>Vehicle</a>
                        <a class="nav-link" href="./report.php"><div class="sb-nav-link-icon"><i class='bx bxs-report'></i></div>Report</a>
                        <a class="nav-link" href="./account.php"><div class="sb-nav-link-icon"><i class='bx bxs-wallet-alt'></i></div>Account</a>
                    </div>
                </div>

                <!-- Sidenav Footer -->
                <div class="sb-sidenav-footer">
                    <h6 class="text-white">Logged in as:<span class="text-warning"> User</span></h6>
                </div>
            </nav>
        </section>
